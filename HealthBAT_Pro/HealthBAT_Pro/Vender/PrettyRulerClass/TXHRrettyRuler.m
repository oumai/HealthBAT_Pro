...
#define INDICATORCOLOR [UIColor whiteColor].CGColor // 中间指示器颜色
...
- (TXHRulerScrollView *)rulerScrollView {
    ...
    if (!_rulerScrollView) {
        ...
        rScrollView.backgroundColor = [UIColor clearColor];
        rScrollView.showsHorizontalScrollIndicator = NO;
        _rulerScrollView = rScrollView;
    }
...
- (void)drawRacAndLine {
    ...
    shapeLayerArc.strokeColor = [UIColor clearColor].CGColor;
