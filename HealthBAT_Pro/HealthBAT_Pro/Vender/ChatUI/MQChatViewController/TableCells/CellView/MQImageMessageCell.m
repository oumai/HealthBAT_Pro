...
//            [bubbleImageView setupImageViewer];
            [bubbleImageView setupImageViewerWithImageURL:[NSURL URLWithString:cellModel.orginPath]];
...
//            [bubbleContentImageView setupImageViewer];
            [bubbleContentImageView setupImageViewerWithImageURL:[NSURL URLWithString:cellModel.orginPath]];
        }
...
//    [alertView show];
    ...
    UIAlertAction *cancelAction = [UIAlertAction actionWithTitle:[MQBundleUtil localizedStringForKey:@"alert_view_cancel"] style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
        
    }];
    
    UIAlertAction *confirmAction = [UIAlertAction actionWithTitle:[MQBundleUtil localizedStringForKey:@"alert_view_confirm"] style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
