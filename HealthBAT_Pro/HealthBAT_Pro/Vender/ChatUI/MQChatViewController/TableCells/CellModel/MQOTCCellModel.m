                                     ...
                                     delegate:(id<MQCellModelDelegate>)delegator
{
    if (self = [super init]) {
        ...
        self.OPDRegisterID = message.OPDRegisterID;
        self.RecipeImgUrl = message.RecipeImgUrl;
        self.RecipeFileID = message.RecipeFileID;
        self.RecipeNo = message.RecipeNo;
        self.RecipeName = message.RecipeName;
        self.Amount = message.Amount;
        self.ReplaceDose = message.ReplaceDose;
        self.ReplacePrice = message.ReplacePrice;
        self.TCMQuantity = message.TCMQuantity;
...
//        self.cellTextAttributes = [[NSDictionary alloc] initWithDictionary:contentAttributes];
        ...
        //文字高度
//        CGFloat messageTextHeight = [MQStringSizeUtil getHeightForAttributedText:self.cellText textWidth:maxLabelWidth] + 1+4;
        
        CGFloat messageTextHeight = 45;
...
- (MQChatBaseCell *)getCellWithReuseIdentifier:(NSString *)cellReuseIdentifer {
    return [[MQOTCMessageCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellReuseIdentifer];
}
