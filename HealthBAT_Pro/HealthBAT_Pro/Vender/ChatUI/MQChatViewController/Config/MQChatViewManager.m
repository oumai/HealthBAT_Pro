...
- (void)setInPutBarHide:(BOOL)hide {

    chatViewConfig.isHideInPutBar = hide;
}

- (void)setIsSearchDisease:(BOOL)isSearchDisease {
    chatViewConfig.isSearchDisease = isSearchDisease;
}

- (void)setFirstMessage:(NSString *)content {
    chatViewConfig.firstMessage = content;
