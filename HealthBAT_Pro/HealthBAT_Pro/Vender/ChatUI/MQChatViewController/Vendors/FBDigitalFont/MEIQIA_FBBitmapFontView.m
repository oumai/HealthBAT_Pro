...
- (void)setup
{
    ...
    self.glowColor      = UIColorFromHEX(0xee3300, 1);
    self.innerGlowColor = UIColorFromHEX(0xee3300, 1);
    self.onColor        = UIColorFromHEX(0xffdd66, 1);
    self.offColor       = UIColorFromHEX(0x222222, 1);
