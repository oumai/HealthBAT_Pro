...
- (UITableView *)rightTableView {
    ...
    if (!_rightTableView) {
        _rightTableView = [[UITableView alloc]initWithFrame:CGRectMake(130, 0, SCREEN_WIDTH - 130, SCREEN_HEIGHT - 65) style:UITableViewStylePlain];
...
- (UITableView *)leftTableView {
    ...
    if (!_leftTableView) {
        _leftTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, 130, SCREEN_HEIGHT - 45) style:UITableViewStylePlain];
        ...
        [_leftTableView registerNib:[UINib nibWithNibName:@"BATLeftAttendCell" bundle:nil] forCellReuseIdentifier:@"leftCell"];
    }
...
- (UIView *)defaultView {
    ...
    if(!_defaultView) {
        ...
        UIImageView *img = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"img-tjfa"]];
