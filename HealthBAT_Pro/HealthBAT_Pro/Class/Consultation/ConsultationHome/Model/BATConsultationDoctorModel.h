...
@class ConsultationDoctorData,ConsultationDoctors,ConsultationDoctorUser,CosultaionDoctorservices;
@interface BATConsultationDoctorModel : NSObject


@property (nonatomic, strong) NSArray<ConsultationDoctorData *> *Data;
...
//@class ConsultationDoctorData,ConsultationDoctors;
//@interface BATConsultationDoctorModel : NSObject
//
//@property (nonatomic, assign) NSInteger PagesCount;
//
...
//
//@end
//@interface ConsultationDoctorData : NSObject
//
//@property (nonatomic, copy) NSString *DeptName;
//
//@property (nonatomic, assign) NSInteger DeptID;
//
//@property (nonatomic, strong) NSArray<ConsultationDoctors *> *Doctors;
//
//@end
//
//@interface ConsultationDoctors : NSObject
//
...
@property (nonatomic, strong) NSArray<CosultaionDoctorservices *> *DoctorServices;
...
@property (nonatomic, strong) ConsultationDoctorUser *User;
...
@interface ConsultationDoctorUser : NSObject
...
@interface CosultaionDoctorservices : NSObject
