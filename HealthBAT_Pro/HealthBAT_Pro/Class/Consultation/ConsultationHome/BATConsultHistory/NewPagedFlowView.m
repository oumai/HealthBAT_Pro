...
//                PGIndexBannerSubiew *cell = [_cells objectAtIndex:i];
                BATFreeClinicDoctorSubview *cell = [_cells objectAtIndex:i];
...
//        }
        if ([NSStringFromClass(view.class) isEqualToString:@"BATFreeClinicDoctorSubview"]) {
            [view removeFromSuperview];
        }
    }
...
//    PGIndexBannerSubiew *cell = [_reusableCells lastObject];
    BATFreeClinicDoctorSubview *cell = [_reusableCells lastObject];
    if (cell)
    {
