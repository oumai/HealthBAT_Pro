//
//  BATConsultationDepartmentDetailModel.h
//  HealthBAT_Pro
//
...
@class ConsultationDepartmentDetailData,ConsultationDepartmentDoctorUser,ConsultationDepartmentDoctorServices;
@interface BATConsultationDepartmentDetailModel : NSObject


@property (nonatomic, strong) NSArray<ConsultationDepartmentDetailData *> *Data;
...
@end
@interface ConsultationDepartmentDetailData : NSObject
...
@property (nonatomic, strong) NSArray<ConsultationDepartmentDoctorServices *> *DoctorServices;
...
@property (nonatomic, strong) ConsultationDepartmentDoctorUser *User;
...
@interface ConsultationDepartmentDoctorUser : NSObject
...
@interface ConsultationDepartmentDoctorServices : NSObject
...
//@class ConsultationDepartmentDetailData;
//@interface BATConsultationDepartmentDetailModel : NSObject
//
//@property (nonatomic, assign) NSInteger PagesCount;
//
