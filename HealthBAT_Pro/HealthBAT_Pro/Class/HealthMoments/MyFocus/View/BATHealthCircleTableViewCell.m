...
@interface BATHealthCircleTableViewCell () <BATHealthCircleCommentTableViewDelegate
...
@implementation BATHealthCircleTableViewCell
...
//        if([model.PhotoPath hasPrefix:@"http://"]){
//
//            [_avatarImageView sd_setImageWithURL:[NSURL URLWithString:model.PhotoPath]placeholderImage:[UIImage imageNamed:@"医生"] options:SDWebImageProgressiveDownload completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
//                if (image) {
...
//            //        [_avatarImageView sd_setImageWithURL:[NSURL URLWithString:model.PhotoPath] placeholderImage:[UIImage imageNamed:@"医生"]];
//        }else{
//            [_avatarImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",BASE_URL,model.PhotoPath]] placeholderImage:[UIImage imageNamed:@"医生"] options:SDWebImageProgressiveDownload completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
//                if (image) {
//                    _avatarImageView.image = [Tools findFace:image];
//                }
//            }];
//            //        [_avatarImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",BASE_URL,model.PhotoPath]] placeholderImage:[UIImage imageNamed:@"医生"]];
//        }
//    }
    ...
    if (model.IsHideCommon) {
     _desLB.text = [NSString stringWithFormat:@"%zd",model.CommentCount];
    }else {
