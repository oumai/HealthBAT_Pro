...
@implementation BATCourseDetailCell
...
- (void)configData:(BATCourseDetailModel *)courseDetailModel
{
    ...
    self.descLabel.attributedText = [self changeDesc:courseDetailModel.Data.Description];
