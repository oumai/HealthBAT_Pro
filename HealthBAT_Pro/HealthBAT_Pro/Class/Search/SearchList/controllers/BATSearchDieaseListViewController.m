...
@interface BATSearchDieaseListViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,BATDoctorCollectionViewCellDelegate>
...
@implementation BATSearchDieaseListViewController
...
- (void)viewDidLoad {
 ...
 //   [self.searchCollectionView.mj_header beginRefreshing];
  //  [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reloadDataAction:) name:@"ROADTODESTION1" object:nil];
