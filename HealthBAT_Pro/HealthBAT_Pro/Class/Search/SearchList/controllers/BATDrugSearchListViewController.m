...
@interface BATDrugSearchListViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,BATDoctorCollectionViewCellDelegate>
...
@implementation BATDrugSearchListViewController
