...
@interface BATHosptialSearchListViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,BATDoctorCollectionViewCellDelegate>
...
@implementation BATHosptialSearchListViewController
