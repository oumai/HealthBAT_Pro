...
@interface BATSearchSymptomListViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,BATDoctorCollectionViewCellDelegate>
...
@implementation BATSearchSymptomListViewController
...
- (void)viewDidLoad {
   ...
   // [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reloadDataAction:) name:@"ROADTODESTION2" object:nil];
