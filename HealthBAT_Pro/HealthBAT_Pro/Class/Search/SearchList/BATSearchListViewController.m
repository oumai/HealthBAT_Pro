...
@interface BATSearchListViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,BATDoctorCollectionViewCellDelegate>
...
@implementation BATSearchListViewController
...
- (void)viewDidLoad {
    ...
    self.typeArray = @[@"",@"disease_info",@"symptom_info",@"drug_info",@"hospital_info",@"beadhouse_info",@"doctor_info",@"news_info"];
     [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reloadDataAction:) name:@"ROADTODESTION" object:nil];
