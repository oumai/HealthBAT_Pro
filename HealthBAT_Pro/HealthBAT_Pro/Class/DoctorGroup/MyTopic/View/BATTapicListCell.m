...
- (void)setDetailModel:(BATTopicDetailModel *)detailModel {
    ...
    [self.headImage sd_setImageWithURL:[NSURL URLWithString:detailModel.Data.TopicImage] placeholderImage:[UIImage imageNamed:@"医生"]];
...
- (void)setModel:(MyTopicListDataModel *)model {
    ...
    [self.headImage sd_setImageWithURL:[NSURL URLWithString:model.TopicImage] placeholderImage:[UIImage imageNamed:@"医生"]];
}
...
- (UIButton *)attentBtn {
    ...
    if (!_attentBtn) {
        ...
        [_attentBtn setBackgroundImage:[UIImage imageNamed:@"person_jgz"] forState:UIControlStateNormal];
        [_attentBtn setBackgroundImage:[UIImage imageNamed:@"icon-ygzb-1"] forState:UIControlStateSelected];
