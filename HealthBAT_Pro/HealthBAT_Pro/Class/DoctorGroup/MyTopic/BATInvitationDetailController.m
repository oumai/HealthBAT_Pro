...
//            personCell.tipsLb.text = [NSString stringWithFormat:@"#%@#",self.model.Data.Topic];
            [personCell.tipsLb setTitle:[NSString stringWithFormat:@"#%@#",self.model.Data.Topic] forState:UIControlStateNormal];
            ...
            if (self.person.Data.AccountID == [self.model.Data.AccountID integerValue]) {
                ...
                if (self.model) {
                    if (self.model.Data.IsUserFollow) {
                        ...
                        personCell.isFollow = self.model.Data.IsUserFollow;
...
//            contentCell.contentLb.text = self.model.Data.PostContent;
        ...
        cell.headimgTapBlocks =^(NSIndexPath *path) {
            ...
            personVC.accountID = data.AccountID;
            [self.navigationController pushViewController:personVC animated:YES];
...
- (UIView *)commentView {
    ...
    if (!_commentView) {
        ...
        if (iPhoneX) {
            _commentView.frame = CGRectMake(0, SCREEN_HEIGHT - 64 - 50 - 24, SCREEN_WIDTH, 50);
        }
