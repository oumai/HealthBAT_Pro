...
@property (nonatomic,strong) UIImageView *scroLineView;
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    self.allBtn.tag = 1;
    [self.allBtn setImage:[UIImage imageNamed:@"wz-jh"] forState:UIControlStateNormal];
//    [self.allBtn  setTitle:@"精华" forState:UIControlStateNormal];
...
//    [self.essenceBtn setTitle:@"全部帖子动态" forState:UIControlStateNormal];
...
//    [self.essenceBtn setTitleColor:BASE_COLOR forState:UIControlStateNormal];
    [self.essenceBtn setImage:[UIImage imageNamed:@"wz-qbdt1"] forState:UIControlStateNormal];
    ...
    self.scroLineView = [[UIImageView alloc]init];
    self.scroLineView.image = [UIImage imageNamed:@"Person_Detail_Head"];
...
- (void)AttendRequesetWithURL:(NSString *)url{
    ...
    [HTTPTool requestWithURLString:url parameters:dict type:kPOST success:^(id responseObject) {
        ...
        NSInteger followNum = [self.model.Data.FollowNum integerValue];
        if (self.model.Data.IsTopicFollow) {
            followNum += 1;
            self.model.Data.FollowNum = [NSString stringWithFormat:@"%zd",followNum];
        }else {
            if (![self.model.Data.FollowNum isEqualToString:@"0"]) {
                followNum -= 1;
                 self.model.Data.FollowNum = [NSString stringWithFormat:@"%zd",followNum];
            }
        }
...
//            [self.allBtn setTitleColor:BASE_COLOR forState:UIControlStateNormal];
            [self.essenceBtn setImage:[UIImage imageNamed:@"wz-qbdt"] forState:UIControlStateNormal];
            [self.allBtn setImage:[UIImage imageNamed:@"wz-jh1"] forState:UIControlStateNormal];
