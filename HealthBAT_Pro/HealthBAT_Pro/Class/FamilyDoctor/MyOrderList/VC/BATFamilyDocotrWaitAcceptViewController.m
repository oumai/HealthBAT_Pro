//
//  BATFamilyDocotrWaitAcceptViewController.m
//  HealthBAT_Pro
//
...
@interface BATFamilyDocotrWaitAcceptViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BATFamilyDocotrWaitAcceptViewController
...
#pragma mark - net
- (void)requestWaitAcceptOrderList{
    
    [HTTPTool requestWithURLString:@"/api/Order/GetFamilyDoctorOrder" parameters:@{@"orderStatus":@(1),@"pageIndex":@(_pageIndex),@"pageSize":@(_pageSize)} type:kGET success:^(id responseObject) {
...
- (void)requestCancelOrder:(NSString *)orderNO indexPathRow:(NSInteger)row{
    ...
    [HTTPTool requestWithURLString:@"/api/FamilyDoctor/CannelOrder" parameters:@{@"OrderNo":orderNO} type:kPOST success:^(id responseObject) {
...
- (UITableView *)familyDoctorOrderListTableView{
    if (!_familyDoctorOrderListTableView) {
        ...
        _familyDoctorOrderListTableView.mj_header = [MJRefreshGifHeader headerWithRefreshingBlock:^{
            ...
            [self requestWaitAcceptOrderList];
        }];
