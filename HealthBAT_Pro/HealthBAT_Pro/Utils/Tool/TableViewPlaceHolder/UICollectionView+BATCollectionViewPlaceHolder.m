//
//  UICollectionView+BATCollectionViewPlaceHolder.m
//  HealthBAT_Pro
//
...
#import "UICollectionView+BATCollectionViewPlaceHolder.h"
#import "BATTableViewPlaceHolderDelegate.h"
...
@implementation UICollectionView (BATCollectionViewPlaceHolder)
...
//                scrollEnabled =
                [self performSelector:@selector(enableScrollWhenPlaceHolderViewShowing)];
//                if (!scrollEnabled) {
...
//                scrollEnabled =
                [self.delegate performSelector:@selector(enableScrollWhenPlaceHolderViewShowing)];
//                if (!scrollEnabled) {
//                    NSString *reason = @"There is no need to return  NO for `-enableScrollWhenPlaceHolderViewShowing`, it will be NO by default";
//                    @throw [NSException exceptionWithName:NSGenericException
//                                                   reason:reason
